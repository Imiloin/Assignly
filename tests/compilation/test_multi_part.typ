...
#assignment(
  ...
  #multi-part(
    ...
    (
      ...
      (
        ...
        [The area under the curve from x=0 to x=2 is 16/3 square units],
      ),
    ),
  )
  ...
  #multi-part(
    ...
    (
      ...
      (
        [用英语解释结果 Explain the results in English],
        [The circle with radius 5 cm has perimeter 10π cm and area 25π cm²],
      ),
    ),
  )
