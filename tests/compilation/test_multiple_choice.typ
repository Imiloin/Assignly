...
#multiple-choice(
  ...
  ($e^(i pi) = -1$, $sin^2(x) + cos^2(x) = 1$, $integral_0^infinity e^(-x^2) dif x = sqrt(pi)/2$, $sum_(n=1)^infinity 1/n^2 = pi^2/6$),
...
#multiple-choice(
  ...
  ("广东 Guangdong", "香港 Hong Kong", "北京 Beijing", "上海 Shanghai", "四川 Sichuan"),
