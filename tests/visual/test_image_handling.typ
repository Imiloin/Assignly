...
#assignment(
  ...
  *Image Integration Examples:*
  ...
  #multi-part(
    ...
    (
      (
        [What type of function is displayed?],
        [This appears to be a parabolic function (quadratic) opening upward],
      ),
      (
        [What is the approximate value at x = 2?],
        [The function appears to have a minimum value at x = 2],
      ),
      (
        [Describe the behavior as x increases from the vertex],
        [The function increases (positive slope) as x moves away from x = 2],
      ),
    ),
    points: 9,
  )
