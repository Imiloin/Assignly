...
#single-choice(
  ...
  ("Nothing special", "Correct answer highlighted", "Only the question", "Student instructions"),
...
#multiple-choice(
  ...
  ("All correct answers", "Wrong answers", "Correct answers only", "No highlighting"),
...
#multi-part(
  ...
  (
    ([What should part (a) show?], [The answer to part (a) should be visible here]),
    ([What should part (b) show?], [The answer to part (b) should be visible here]),
    ([How are answers formatted?], [Answers should be in colored boxes or highlighted sections])
  ),
  points: 9
)
...
#multi-part(
  ...
  (
    ...
    ([What should part (b) show?], [Students should NOT see this answer either]),  
    ([How are answers formatted?], [Students should only see empty answer lines])
  ),
  points: 9
)
