...
#assignment(
  ...
  #section("Calculus Questions")[
    ...
    #fill-blank(
      [
        ...
        $integral_a^b f(x) d x = $ #fill-blank-space(answer: "F(b) - F(a)", width: "6cm")
  ...
  #note-box("String-based questions (legacy mode) continue to work exactly as before!", type: "info")
