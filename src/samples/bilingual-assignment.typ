...
#assignment(
  ...
  #multi-part(
    ...
    (
      [Name one difference between American and Chinese educational systems. / 说出美国和中国教育系统的一个差异。],
      [What is a common value shared by both cultures regarding education? / 两种文化在教育方面有什么共同价值观？],
      [How might language differences affect learning approaches? / 语言差异如何影响学习方法？],
    ),
    points: 12,
  )
  ...
  #note-box(
    "Remember to pay attention to cultural context when translating. / 翻译时要注意文化语境。",
    type: "warning",
  )

  #note-box(
    "Both languages have their unique beauty and complexity. / 两种语言都有其独特的美感和复杂性。",
    type: "info",
  )
]
