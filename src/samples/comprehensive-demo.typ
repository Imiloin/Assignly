...
#assignment(
  ...
  #note-box("Welcome to the Assignly template demonstration! This document shows all available features.", type: "success")
  ...
  #section("Single Choice Questions", instructions: "Choose the best answer for each question.")[
    
    #single-choice(
      "Which of the following best describes the Assignly template?",
      ("A simple document template", "A comprehensive assignment creation system", "A basic quiz generator", "A text editor"),
      1,
      points: 2,
  ...
  #section("Multiple Choice Questions", instructions: "Select ALL correct answers.")[
    ...
    #multiple-choice(
      ...
      ("Dual-mode rendering", "Bilingual support", "Question numbering", "Answer explanations", "Custom fonts", "Time tracking"),
      (0, 1, 2, 3, 4),
      points: 5,
  ...
  #section("True/False Questions", instructions: "Mark each statement as true or false.")[
  ...
  #section("Fill-in-the-Blank Questions", instructions: "Complete each sentence with the appropriate word(s).")[
  ...
  #section("Short Answer Questions", instructions: "Provide complete answers in the space provided.")[
  ...
  #section("Multi-Part Questions", instructions: "Answer all parts of each question.")[
    
    #multi-part(
      "Template Architecture Analysis:",
      ([Identify the three main modules of the Assignly template.], [Explain the role of the state management system.], [Describe how the layout system handles responsive formatting.]),
      points: 15
    )

    #multi-part(
      "Implementation Scenarios:",
      ([How would you create an assignment with both English and Chinese content?], [What steps are needed to generate both student and teacher versions?], [How can you customize the appearance for different academic disciplines?]),
      points: 18
    )
  ]
  ...
  #section("Advanced Formatting Features")[
    ...
    #note-box("Information boxes help highlight important points.", type: "info")
    
    #note-box("Warning boxes draw attention to critical information.", type: "warning")
    
    #note-box("Error boxes indicate mistakes or issues.", type: "error")
    
    #note-box("Success boxes celebrate achievements or correct answers.", type: "success")
  ...
  #section("Assessment Summary", numbered: true)[
    ...
    #single-choice(
      ...
      ("Basic - covers only essential features", "Good - handles most common needs", "Excellent - comprehensive and professional", "Perfect - exceeds all expectations"),
      2,
      points: 2,
  ...
  #note-box("This demonstration showcases the template's full potential. To see teacher mode, change show-answers to true in the assignment function.", type: "info")
